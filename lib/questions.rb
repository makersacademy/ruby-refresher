...
def get_first_half_of_string(string)
  ...
  split = length / 2
    length.odd? ? string.slice(0, (split+1)) : string.slice(0, split)
end
...
def average_of_array(array)
  avg = array.reduce(:+) / array.length.to_f
  avg.ceil
end
