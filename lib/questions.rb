...
def select_elements_starting_with_a(array)
  array.select { |word| word[0].eql?('a')}
end
...
def titleize_a_string(string)
  string.split.inject([]) { |words, word| words << (%w(a and the).include?(word) && words.any? ? word : word.capitalize)}.join(' ')
end
...
def is_a_2014_bank_holiday?(date)
  bank_holidays = { "New Year's Day": Time.new(2014, 1, 1),
                    "Good Friday":    Time.new(2014, 4, 18),
                    "Easter Monday":  Time.new(2014, 4, 21),
                    "Early May":      Time.new(2014, 5, 5),
                    "Spring":         Time.new(2014, 5, 26),
                    "Summer":         Time.new(2014, 8, 25),
                    "Christmas Day":  Time.new(2014, 12, 25),
                    "Boxing Day":     Time.new(2014, 12, 26)}
