...
def select_elements_starting_with_a(array)
  selected_array = array.select {|element| element[0] == "a"}
  return selected_array
end

# keep only the elements that start with a vowel
def select_elements_starting_with_vowel(array)
  selected_array = array.select {|element| element[0] =~ /[aeiou]/}
  return selected_array
end
...
def all_elements_except_first_3(array)
  array.select.each_with_index {|element, index| index > 2}
end
...
def array_sort_by_last_letter_of_word(array)
  ...
  sorted_array = reverse_array.sort_by {|word| word}
  return sorted_array.map{|word| word.reverse}
end
...
def get_first_half_of_string(string)
  number = string.length.to_f
  slice_to = (number/2).ceil
  return string.slice(0, slice_to)
end
...
def remove_capital_letters_from_string(string)
  chars = string.chars
  return chars.each {|char| chars.delete(char) if char =~ /[A-Z]/}.join
end
