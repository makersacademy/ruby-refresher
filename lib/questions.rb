...
def select_elements_starting_with_vowel(array)
  array.select { |elem| (elem[0] == 'a') || (elem[0] == 'e') || (elem[0] == 'i') || (elem[0] == 'o')|| (elem[0] == 'u') }
end
...
def is_a_3_dot_range?(range)
  #return true if range.include? "..."
  #return false if range.include? ".."
end
...
def word_count_a_file(file_path)
  #file.open.file_path.split.size
end
