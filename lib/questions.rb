...
def select_elements_starting_with_vowel(array)
  array.select { |x| "aeiou".include? x.chars[0] }
end
...
def remove_nils_and_false_from_array(array)
  array.compact.select { |x| x != false }
end
...
def separate_array_into_even_and_odd_numbers(array)
  a = [];
  a.push(array.each.select {|x| x.even?})
  a.push(array.each.select {|x| x.odd?})
  a
end
