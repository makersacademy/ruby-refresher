...
def select_elements_starting_with_vowel(array)
  vowels = %w{ a e i o u }
  array.select { |e| vowels.include? e[0] }
end
...
def titleize_a_string(string)
    string.split.each_with_index do |word, i| 
      word.capitalize! unless ['the', 'and', 'a'].include?(word) and i > 0 
    end.join(' ')
end
...
def fizzbuzz_without_modulo(n)
  return 'fizzBuzz' if n - (n/3)*3 == 0 && n - (n/5)*5 == 0
  return 'fizz' if n - (n/3)*3 == 0
  return 'buzz' if n - (n/5)*5 == 0
end
