...
def separate_array_into_even_and_odd_numbers(array)
  odd, even = [], []
  array.each {|num| num % 2 == 0 ? even << num : odd << num}
  array = []
  array << even
  array << odd
end
...
def number_of_elements_that_are_palindromes(array)
  array.delete_if {|word| word != word.reverse}
  array.length
end
...
def average_of_array(array)
  total = 0
  array.inject{|sum, elem| total = sum + elem}
  average = (total / array.length.to_f).ceil
end
...
def titleize_a_string(string)
  title_cases = Hash.new {|_,k| k.capitalize }.merge({'And' => 'and', 'The' => 'the', 'A' => 'a'})
  new_string  = string.split(" ").map {|w| title_cases[w] }.join(' ')
