...
def remove_nils_and_false_from_array(array)
  array.compact.keep_if{ |obj| obj != false }
end
...
def get_first_half_of_string(string)
  ...
  string.length.even? ? string[0..word-1] : string[0..word]
end
...
def separate_array_into_even_and_odd_numbers(array)
  numbers = array.group_by { |num| num % 2 }
  [numbers[0], numbers[1]]
end
...
def number_of_elements_that_are_palindromes(array)
  array.select { |word| word if word.reverse == word }.count
end
...
def is_a_2014_bank_holiday?(date)
  holidays = ['2014-01-01', '2014-04-18', '2014-04-21', '2014-05-05', '2014-05-26', '2014-08-25', '2014-12-25', '2014-12-26']
