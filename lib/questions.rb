...
def is_a_2014_bank_holiday?(date)
  ...
  %w(1/1 18/4 21/4 5/5 26/5 25/8 25/12 26/12).include?(dm)
end
...
def your_birthday_is_on_a_friday_in_the_year(birthday)
  until birthday.friday?
    birthday = Date.new(birthday.year + 1, birthday.month, birthday.day)
  end
  birthday.year
end
