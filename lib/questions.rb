...
def get_first_half_of_string(string)
  ...
  if string.length % 2 == 0
    ...
    string.slice(0..((string.length+1)/2)-1)
  end
...
def separate_array_into_even_and_odd_numbers(array)
  ...
  array.each do |word|
    if word % 2 == 0
     ...
     arr_together << arr_even
     arr_together << arr_odd
     return arr_together
...
def number_of_elements_that_are_palindromes(array)
  ...
  array.map do |word|
    if word == word.reverse
      array_palindromes << word
    end
  end
    return array_palindromes.length
end
...
def get_domain_name_from_email_address(email)
  email.split("@").last.slice(/makersacademy/)
end
...
def is_a_2014_bank_holiday?(date)
  require 'time'
  new_array = []
  bank_holidays = ['2014-12-26','2014-12-25','2014-08-25',
  '2014-05-26','2014-05-05','2014-04-21',
  '2014-04-18','2014-01-01']
  bank_holidays.map do |holis|
    if Time.parse(holis) == date
    new_array << Time.parse(holis)
    end
  end
    !new_array.empty?
