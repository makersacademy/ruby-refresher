...
def get_first_half_of_string(string)
  ...
  n = (str_size.odd?) ? str_size / 2 : str_size / 2 - 1
  string.slice(0..n)
end
...
def separate_array_into_even_and_odd_numbers(array)
  result = []
  hash = array.group_by { |n| n.even? }
  result << hash[true] << hash[false]
end
...
def get_elements_until_greater_than_five(array)
  result = []
  array.each { |e| break if e > 5 ; result << e }
  result
end
...
def is_a_2014_bank_holiday?(date)
  pretty_date = format_date_nicely(date)
  bank_holidays = ['01/01/2014',
                   ...
                   '25/12/2014',
                   '26/12/2014' ]
  bank_holidays.include? pretty_date
end
