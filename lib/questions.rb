...
def separate_array_into_even_and_odd_numbers(array)
  even = []
  odd = []
  array.each do |number| if number.even?
                            even << number
                          else
                            odd << number
                          end
...
def number_of_elements_that_are_palindromes(array)
  ...
  array.each do |element| if element == element.reverse
...
def double_array(array)
   duplicate = []
   2.times do array.each{ |number| duplicate << number } end
   duplicate
end
...
def average_of_array(array)
  (array.inject(0,:+).to_f/array.length).ceil
end
...
def get_elements_until_greater_than_five(array)
  new_array = []
  array.select { |number| break if number > 5
                  new_array << number }
  new_array
end
...
def titleize_a_string(string)
  string.capitalize!.split.map do
    |word| if ["a", "and", "the"].include?(word)
              word
            else
              word.capitalize
            end
