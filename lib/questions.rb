...
def separate_array_into_even_and_odd_numbers(array)
  result = []
  result.push(array.select { |number| number.even? })
  result.push(array.select { |number| number.odd? })
  result
end
...
def convert_array_to_a_hash(array)
  keys = array.select.with_index { |element, index| index.even? }
  values = array.select.with_index { |element, index| index.odd? }
...
def remove_capital_letters_from_string(string)
  string.chars.select { |char| char == char.downcase }.join
end
