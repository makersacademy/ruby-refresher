require_relative 'bank_holidays_2014'
...
def word_count_a_file(file_path)
  ...
  text.each_line { |line| total_words += line.split(' ').count }
  total_words
end
...
def is_a_2014_bank_holiday?(date)
  bank_holidays = BankHolidays2014.dates
...
def count_words_of_each_length_in_a_file(file_path)
  ...
  words = Hash.new(0)
  file.read.scan(/\w+/).each { |word| words[word.length] += 1 }
  words
end
