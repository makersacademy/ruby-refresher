...
def select_elements_starting_with_a(array)
  array.delete_if { |a| a.split("")[0] != "a" }
end

# keep only the elements that start with a vowel
def select_elements_starting_with_vowel(array)
  # array.select { |a| a.split("")[0] == a[/[aeiou]/] }
  array.select { |a| a.split("")[0].match(/a|e|i|o|u/) }
end
...
def remove_nils_and_false_from_array(array)
  array.delete_if { |a| a == nil || a == false}
end
...
def get_first_half_of_string(string)
  half = string.size / 2
  string.size.even? ? string.slice(0...half) : string.slice(0..half)
end
...
def separate_array_into_even_and_odd_numbers(array)
  arr1 = array.select { |n| n.even? }
  arr2 = array.select { |n| n.odd? }
  arr3 = []
  arr3.push(arr1, arr2)
end
...
def number_of_elements_that_are_palindromes(array)
  array.select { |n| n == n.reverse }.length
end
...
def is_a_2014_bank_holiday?(date)
  holidays = ['2014-05-26','2014-08-25', '2014-12-25', '2014-12-26']
...
def count_words_of_each_length_in_a_file(file_path)
   ...
   file = file.read.gsub(/[^a-z0-9\s]/i, '').split(" ")
   file.sort_by! { |word| word.length }
