...
describe 'the Friday test :)' do
  ...
  it '11. make_numbers_negative' do
  ...
  it '12. separate_array_into_even_and_odd_numbers' do
    n = separate_array_into_even_and_odd_numbers [1, 2, 3, 4, 5, 6, 7]
    expect(n).to eq [[2, 4, 6], [1, 3, 5, 7]]
  end

  it '13. number_of_elements_that_are_palindromes' do
  ...
  it '18. turn_symbol_into_string' do
    n = turn_symbol_into_string :foobar
    expect(n).to eq 'foobar'
  end

  it '19. average_of_array' do
  ...
  fit '37. is_a_2014_bank_holiday?' do
  ...
  fit '38. your_birthday_is_on_a_friday_in_the_year' do
    n = your_birthday_is_on_a_friday_in_the_year(Time.new(2013, 1, 1))
    expect(n).to eq 2016
  end

  fit '39. count_words_of_each_length_in_a_file' do
